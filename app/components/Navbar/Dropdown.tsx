...
const Dropdown = () => {
  ...
  return (
    ...
    {isOpen && (
         <div className='absolute left-1/2 -translate-x-1/2 mt-2 flex flex-col justify-center items-center bg-[#0b1622] px-5 py-2 rounded-2xl text-xl w-max text-white border border-white/10 shadow-xl z-50'>
